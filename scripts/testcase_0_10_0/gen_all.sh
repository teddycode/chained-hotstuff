...
python3 ../gen_conf.py --ips replicas_inter.txt --iter 1 --prefix 'hotstuff.gen' --keygen ../../bin/hotstuff-keygen --tls-keygen ../../bin/hotstuff-tls-keygen --block-size 400  --delta 0.01 --pace-maker rr
